...
void ParametricCurve::setup()
{
	...
	ctrlPoint1 = { -200, -300, 0 };
	ctrlPoint2 = { -100, -100, 0 };
	ctrlPoint3 = { 100, 200, 0 };
	ctrlPoint4 = { 200, 400, 0 };
	ctrlPoint5 = { 300, 300, 0 };
	ctrlPoint6 = { 500, 200, 0 };
}
...
void ParametricCurve::draw()
{
	...
	for (index = 0; index <= lineResolution; ++index)
	{
		...
		if (m_curveType == "bezier_quad")
		{
			...
			//Masquer les points de contr�les non utilis�s
...
// fonction d'�valuation d'une courbe de B�zier quadratique (3 points de contr�le)
